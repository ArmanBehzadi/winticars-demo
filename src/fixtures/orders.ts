...
export const SEED_ORDERS: Order[] = [
  ...
  },
  {
    ...
    carLabel: "Skoda Octavia Combi (2018)",
    requesterName: "Auto Eulachblick GmbH",
    providerId: "p-glanz-eulach",
    providerName: "GlanzWerk Eulachtal",
    status: "bestätigt",
    priceChf: 190,
    whenText: "Mi, 09:00 Annahme",
    createdText: "vor 2 Std.",
    messages: [
      { id: "m-1", from: "requester", text: "Vollaufbereitung innen/aussen vor dem Inserat, bitte.", timeText: "vor 3 Std." },
      { id: "m-2", from: "provider", text: "Eingeplant Mittwoch 09:00. Richtpreis CHF 190.", timeText: "vor 2 Std." },
    ],
  },
  {
    id: "o-1012",
    ...
    priceChf: 220,
    whenText: "Termin offen",
    createdText: "vor 45 Min.",
    messages: [
      { id: "m-1", from: "requester", text: "Aufbereitung + Lederpflege, wann hättet ihr Platz?", timeText: "vor 45 Min." },
    ],
  },
];
